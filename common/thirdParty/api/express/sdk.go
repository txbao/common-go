...
const (
	AppCode   = "14b9336aaa014545ac3506093a8b52c2"
...
func NewSdk() (*expressSdk, error) {
	return &expressSdk{}, nil
}
...
func (o *expressSdk) GetPressType() (*ExpressType, error) {
	...
	resStr, err := utils.HttpGetResty(Host+PathType, args, headerMap, &expressType)
	//记录结束时间
